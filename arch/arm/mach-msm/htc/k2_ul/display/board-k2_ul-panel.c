/* linux/arch/arm/mach-msm/display/k2_ul-panel.c
 *
...
void __init k2_ul_allocate_fb_region(void)
{
	void *addr;
	unsigned long size;
...
void __init k2_ul_mdp_writeback(struct memtype_reserve* reserve_table)
{
...
static struct mipi_dsi_panel_platform_data k2_ul_pdata = {
	.dlane_swap = 1,
...
static struct platform_device mipi_dsi_k2_ul_panel_device = {
	.name = "mipi_k2_ul",
	.id = 0,
	.dev = {
		.platform_data = &k2_ul_pdata,
	}
};
...
void __init k2_ul_init_fb(void)
{
	msm8960_set_display_params("mipi_k2_ul", "hdmi_msm");
	platform_device_register(&msm_fb_device);
#ifdef CONFIG_FB_MSM_WRITEBACK_MSM_PANEL
        platform_device_register(&wfd_panel_device);
        platform_device_register(&wfd_device);
#endif
	platform_device_register(&mipi_dsi_k2_ul_panel_device);
